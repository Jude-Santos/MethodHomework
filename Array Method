/**
 * Write a description of class CopyOfFillingAnArray here.
 *
 * @author (Ms. Schulze)
 * @version (1.0)
 */
...
public class FillingAnArray
{
    ...
    static void inputArray(int number,String[] myStringArray) {
    ...
    static void forLoop(int number,String[] myStringArray) {
        for (int i = 0; i < number; i++) {
                int numberPlusOne = i + 1;
                System.out.println("The string in position " + numberPlusOne + " is " + myStringArray[i] + ".");
            }
    }
    static void Replace(boolean fillAnElement,int elementNumber,String[] myStringArray) {
        Scanner myScanner = new Scanner(System.in);
        while (fillAnElement) {
                ...
                System.out.print("Type true if you'd like to replace one or more elements in the array. Type false if you would like to see what the program is like now.");
                fillAnElement = myScanner.nextBoolean();

            }
    }
    static boolean valueChange() {
        boolean fillAnElement;
        Scanner myScanner = new Scanner(System.in);
        System.out.print("Type true if you'd like to replace one or more elements in the array. Type false if you don't want to replace any number.");
            fillAnElement = myScanner.nextBoolean();
